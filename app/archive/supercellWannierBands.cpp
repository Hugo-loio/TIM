...
int main (int arc, char ** argv) {
  ...
  bbh2D.getSupercellWannierBands(argv[0], "SupercellWannierBandsBBH2D_inter0.99_x.dat", 5, 5, 0);

  bbh2D.setInterHop(1.01);
  bbh2D.getSupercellWannierBands(argv[0], "SupercellWannierBandsBBH2D_inter1.01_x.dat", 5, 5, 0);

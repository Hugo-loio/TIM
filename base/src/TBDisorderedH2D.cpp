...
void TBDisorderedH2D::fillHopWrapper(cx_mat & res, int hopIndex, double *k, int dim, int addI, int addJ, int addN, int * startI){
  fillHop<cx_mat>(res, hopIndex, k, dim, addI, addJ, addN, startI);
}

void TBDisorderedH2D::fillHopWrapper(sp_cx_mat & res, int hopIndex, double *k, int dim, int addI, int addJ, int addN, int * startI){
  fillHop<sp_cx_mat>(res, hopIndex, k, dim, addI, addJ, addN, startI);
}

void TBDisorderedH2D::fillOnSiteWrapper(cx_mat & res, int onSiteIndex, double * k, int dim, int addN, int * startI){
  fillOnSite<cx_mat>(res, onSiteIndex, k, dim, addN, startI);
}

void TBDisorderedH2D::fillOnSiteWrapper(sp_cx_mat & res, int onSiteIndex, double * k, int dim, int addN, int * startI){
  fillOnSite<sp_cx_mat>(res, onSiteIndex, k, dim, addN, startI);
}

template <class mat> void TBDisorderedH2D::fillOnSite(mat & res, int onSiteIndex, double * k, int dim, int addN, int * startI){
  int e = onSiteIndex;
  int j,n;
...
template <class mat> void TBDisorderedH2D::fillHop(mat & res, int hopIndex, double * k, int dim, int addI, int addJ, int addN, int * startI){
  complex<double> t;
  int j,n,q,r;

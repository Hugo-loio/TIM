...
#labelsPol = ["L = 10", "L = 50"]
namesPol = ["phaseDiagramSOTAIpol_100x100_m1.1","phaseDiagramSOTAIpol_200x200_m1.1", "phaseDiagramSOTAIpol_300x300_m1.1", "phaseDiagramSOTAIpol_400x400_m1.1"]
labelsPol = ["L = 100", "L = 200", "L = 300", "L = 400"]
